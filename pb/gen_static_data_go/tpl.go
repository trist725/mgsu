...
func (mgr *{{.Name}}Manager) Load(excelFilePath string) (success bool) {
	success = true
...
func (mgr {{.Name}}Manager) check(excelFilePath string, row int, sd *{{.Name}}) error {
...
func (mgr *{{.Name}}Manager) AfterLoadAll(excelFilePath string) (success bool) {
	success = true
	//////////////////////////////////////////////////////////////////////////////////////////////////
	// TODO 添加加载后处理代码
...
func LoadAll(excelDir string) (success bool) {
	...
	success = {{.Name}}Mgr.Load(filepath.Join(absExcelDir, "{{.ExcelFileBaseName}}")) && success
    {{end}}
...
func AfterLoadAll(excelDir string) (success bool) {
	...
	{{range .StaticDataMetas}}
	success = {{.Name}}Mgr.AfterLoadAll(filepath.Join(absExcelDir, "{{.ExcelFileBaseName}}")) && success
    {{end}}
