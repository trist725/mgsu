...
func (S2C_Register_E_Error) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{2, 0}
}
...
func (S2C_Register_E_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{2, 1}
}
...
func (S2C_Login_E_Error) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{4, 0}
}
...
func (*S2C_Close) Descriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{0}
}
...
func (dst *S2C_Close) XXX_Merge(src proto.Message) {
	xxx_messageInfo_S2C_Close.Merge(dst, src)
}
...
func (*C2S_Register) Descriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{1}
}
...
func (dst *C2S_Register) XXX_Merge(src proto.Message) {
	xxx_messageInfo_C2S_Register.Merge(dst, src)
}
...
func (*S2C_Register) Descriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{2}
}
...
func (dst *S2C_Register) XXX_Merge(src proto.Message) {
	xxx_messageInfo_S2C_Register.Merge(dst, src)
}
...
func (*C2S_Login) Descriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{3}
}
...
type S2C_Login struct {
	...
	// / 服务器列表
	Server []*S2C_Login_ServerInfo `protobuf:"bytes,3,rep,name=Server" json:"Server,omitempty"`
	// / 上次登录服务器ID
...
func (*S2C_Login) Descriptor() ([]byte, []int) {
	return fileDescriptor_login_7847a9d28a73a927, []int{4}
}
...
func (dst *S2C_Login_ServerInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_S2C_Login_ServerInfo.Merge(dst, src)
}
...
func init() { proto.RegisterFile("login.proto", fileDescriptor_login_7847a9d28a73a927) }

var fileDescriptor_login_7847a9d28a73a927 = []byte{
